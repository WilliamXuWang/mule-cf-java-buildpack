...
#require 'java_buildpack/container/mule/tomcat_utils'
require 'java_buildpack/util/tokenized_version'

module JavaBuildpack
  module Container

    # Encapsulates the detect, compile, and release functionality for the Mule instance.
    class MuleInstance < JavaBuildpack::Component::VersionedDependencyComponent
      ...
      MULE_3_7_2 = JavaBuildpack::Util::TokenizedVersion.new('3.7.2').freeze

      private_constant :MULE_3_7_2
      ...
      def expand(file)
        with_timing "Expanding Mule runtime to #{@droplet.sandbox.relative_path_from(@droplet.root)}" do
          FileUtils.mkdir_p @droplet.sandbox
          shell "tar xzf #{file.path} -C #{@droplet.sandbox} --strip 1 --exclude apps 2>&1"
