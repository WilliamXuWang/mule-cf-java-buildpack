...
require 'java_buildpack/container/tomcat/mule_instance'
...
module JavaBuildpack
  module Container
    ...
    # Encapsulates the detect, compile, and release functionality for Mule applications.
    class Mule < JavaBuildpack::Component::ModularComponent
      ...
      def command
        ...
        [
          ...
          "$PWD/#{(@droplet.sandbox + 'bin/mule').relative_path_from(@droplet.root)}",
          'run'
      ...
      def sub_components(context)
        [
          MuleInstance.new(sub_configuration_context(context, 'mule')),
